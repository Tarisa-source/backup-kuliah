...
class Coba2 {
    ...
    public static void editData (formatBiodata biodataMahasiswa[]){
		// bagian membuat record sementara untuk menampung data baru-------------
		formatBiodata biodataMahasiswaBaru = new formatBiodata();
		// bagian menentukan posisi yang ingin di edit
		Scanner masukan = new Scanner(System.in);
		int T;
		...
		// bagian memindahkan data baru ke larik ke-A-----------------------
		biodataMahasiswa[0] = biodataMahasiswaBaru;
		// memperbaharui banyaknya data (N), banyaknya data bertambah satu------
        N++;
	}
	...
	public static void mencariDataLinear(formatBiodata biodataMahasiswa[]){
		...
		if (statusKetemu == true){
			...
			System.out.println(tampilkanData(biodataMahasiwa[i]));
		}else{
    ...
    public static void main(String[] args) { // bagian deklarasi record berbasis LARIK -----------------------
        ...
        while (jawab.equals("Y")) {
            ...
            System.out.println("--Pilihan lainya--");
            System.out.println("7. Menukarkan data");
            System.out.println("8. Edit Data");
            System.out.println("9. Mencari data secara linier (For)");
            System.out.println("10. Mencari data secara linier (While)");
            System.out.println("11. Mencari data secara biner ");
            ...
            if (tambah == 1) {
                ...
                System.out.println("Data baru yang telah di edit");
				tampilkanData(biodataMahasiswa);
            }else if (tambah == 9 ) {
